...
export const NAV_ITEMS: NavItem[] = [
  ...
  { to: "/cierres", label: "Cierres de caja", icon: History, roles: STAFF, color: "bg-lime-100 text-lime-600" },
  { to: "/movimientos", label: "Movimientos", icon: ArrowLeftRight, roles: STAFF, color: "bg-teal-100 text-teal-600" },
